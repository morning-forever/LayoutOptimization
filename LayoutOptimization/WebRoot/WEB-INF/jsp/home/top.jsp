...
<body class="PageBody" style="margin: 0">
	...
	<div id="Head1">
		<div id="Logo">
            ...
            <font color="#0000CC" style="color:#F1F9FE; font-size:28px; font-family:Arial Black, Arial">区域供热供冷优化与设计系统</font> 
		...
		<div id="Head1Right">
			...
			<div id="Head1Right_UserSetup">
            	<a href="javascript:void(0)">
					<img border="0" width="13" height="14" src="CSS/images/top/user_setup.gif" /> 
				</a>
			</div>
        ...
        <div id="Head1Right_Button">
            <a target="desktop" href="/desktop?method=show">
				<img width="65" height="20" alt="显示模型" src="CSS/blue/images/top/desktop.gif" />
			</a>
        </div>
	</div>
