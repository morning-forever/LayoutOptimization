...
<body>&nbsp; 
	...
	<fieldset>
		<div class="form-row">
            ...
            <div class="field-widget"><input name="projectId" id="field1" class="required" title="请输入"  /></div>
        </div>
        <div class="form-row">
            <div class="field-label"><label for="field1">工程名称</label>:</div>
            <div class="field-widget"><input name="projectName" id="field1" class="required" title="请输入"  /></div>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field2">工程类型</label>:</div>
            <div class="field-widget"><input name="projectKind" id="field2" class="required" title="请输入" /></div>
        </div>
    </fieldset>
