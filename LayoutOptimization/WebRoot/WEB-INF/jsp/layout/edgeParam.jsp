...
<script type="text/javascript">
	function delete_confirm(id) {
		jConfirm('确定删除该管道？', '提示信息', function(r) {
			if(r){
				window.location.href="layout_deleteEdgeParam.action?id="+id;
			}
		});
	}
</script>
	...
	<div id="MainArea">
				...
				<s:iterator value="#request.edges" status="status">
					<tr align="CENTER" valign="MIDDLE" id="TableTitle">
						...
						<td><a onclick="delete_confirm(${id})">删除</a> <s:a
								action="layout_edgeParamEditUI?id=%{id}">修改</s:a></td>
		...
		<div id="TableTail">
			<div id="TableTail_inside">
				<a href="layout_edgeParamAddUI.action"><img src="CSS/images/createNew.png" /></a>
			</div>
		</div>
	</div>
</body>
