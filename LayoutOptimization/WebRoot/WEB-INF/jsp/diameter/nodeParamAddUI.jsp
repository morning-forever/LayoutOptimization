...
<body>&nbsp; 
	...
	<fieldset>
        ...
        <div class="form-row">
            ...
            <div class="field-widget"><input name="nodeXnd" id="field2" class="required" title="请输入"  /></div>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field3">Y坐标</label>:</div>
            <div class="field-widget"><input name="nodeYnd" id="field3" class="required" title="请输入" /></div>
        </div>
        <div class="form-row">
